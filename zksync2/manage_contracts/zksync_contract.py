...
class ZkSyncContract:
    ...
    def request_l2_transaction(self,
                               ...
                               l1_max_priority_fee: int,
                               l1_max_fee: int,
                               l1_value: int):
        nonce = self._nonce()
        gas_estimate = self._method_("requestL2Transaction")(contract_l2,
                                                             l2_value,
                                                             call_data,
                                                             l2_gas_limit,
                                                             l2_gas_per_pubdata_byte_limit,
                                                             factory_deps,
                                                             refund_recipient).estimate_gas({"from": self.account.address, "value": l1_value})
        # print(f"gas_estimate: {gas_estimate}")
        eth_fee_required = gas_estimate * l1_max_fee * 101 // 100
        # print(f"eth_fee_required: {eth_fee_required}")
        l1_value = l1_value - eth_fee_required
        # print(f"l1_value: {l1_value}")
        l2_value = l2_value - eth_fee_required
        ...
        tx = self._method_("requestL2Transaction")(contract_l2,
                                                   ...
                                                   refund_recipient).build_transaction(
            {
                "nonce": nonce,
                'from': self.account.address,
                "maxFeePerGas": l1_max_fee,
                "maxPriorityFeePerGas": l1_max_priority_fee,
                "gas": gas_estimate * 101 // 100,
                "value": l1_value
            })
    ...
    def l2_tx_base_cost(self,
        ...
        return self._method_("l2TransactionBaseCost")(l1_max_fee,
                                                      l2_gas_limit,
